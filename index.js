...
// let homaFinals2014 = fifaData.filter(function(item) {
//     return item.Year == 2014 && item.Stage == "Final"
// })

// console.log(homaFinals2014[0]["Home Team Name"])

//(b) Away Team name for 2014 world cup final

// let awayFinal2014 = fifaData.filter(function(item){
//     return item.Year == 2014 && item.Stage == "Final"
// })

// console.log(awayFinal2014[0]["Away Team Name"])

//(c) Home Team goals for 2014 world cup final

// console.log(homaFinals2014[0]["Home Team Goals"])

//(d) Away Team goals for 2014 world cup final

// console.log(awayFinal2014[0])

//(e) Winner of 2014 world cup final */

// console.log(awayFinal2014[0]["Win conditions"])
...
function getWinners(getFinalsCB) {
    let winners = []
    getFinalsCB.forEach(function(item){
        item["Home Team Goals"] > item["Away Team Goals"] ? winners.push(item["Home Team Name"]) : winners.push(item["Away Team Name"])
    })
    return winners
}
...
Parameters: 
 * callback function getWinners -> Me retorna Array de nombres
 * callback function getYears -> Me retorna Array de annios
 */
